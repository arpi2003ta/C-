        ...
        switch (choice) {
            case 1: {
                if (rows1 != rows2 || cols1 != cols2) {
                    cout << "Addition requires matrices of the same dimensions.\n";
                    break;
                }
            ...
            case 2: {
                if (rows1 != rows2 || cols1 != cols2) {
                    cout << "Subtraction requires matrices of the same dimensions.\n";
                    break;
                }
            ...
            case 3: {
                if (cols1 != rows2) {
                    cout << "Matrix multiplication requires the number of columns of the first matrix to equal the number of rows of the second matrix.\n";
                    break;
                }
